...
urlpatterns = [
    ...
    path('api/chat/conversations/', views.chat_conversations_list, name='chat-conversations'),
    path('api/chat/conversations/new/', views.chat_new_conversation, name='chat-new-conversation'),
    path('api/chat/conversations/<int:conversation_id>/messages/', views.chat_conversation_messages, name='chat-conversation-messages'),
